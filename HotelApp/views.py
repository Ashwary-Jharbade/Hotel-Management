...
def fitness(request):
    ...
    if request.method == 'POST':
        ...
        send_mail('Royal Hotel Fitness Pack :','Pack Deatils :- {}'.format(mailMessage),'developeremail',[email])
...
def roombooking(request,id):
    ...
    if request.method == 'POST':
        ...
        send_mail('Royal Hotel - Room Booking Service :-',' Booking :- {}'.format(mailMessage),'developeremail',[email])
...
def orderfood(request):
    if request.method == 'POST':
        ...
        send_mail('Royal Hotel - Food Service','Invoice :- {}'.format(mailMessage),'developeremail',[email])
